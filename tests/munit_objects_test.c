...
int munit_objects_tests_cases(int argc,
  ...
  MunitTest test_suite_tests_misc[] = {
      munit_test("object/test_new_snek_integer", test_new_snek_integer),
      munit_test("object/test_new_snek_float", test_new_snek_float),
      munit_test("object/test_new_snek_string", test_new_snek_string),
      munit_test("object/test_new_snek_vector", test_new_snek_vector),
      munit_test("object/test_new_snek_array", test_new_snek_array),
      munit_test("object/test_snek_array_set", test_snek_array_set),
      munit_test("object/test_snek_array_get", test_snek_array_get),
      {.name = NULL,
       .test = NULL,
       .setup = NULL,
       .tear_down = NULL,
